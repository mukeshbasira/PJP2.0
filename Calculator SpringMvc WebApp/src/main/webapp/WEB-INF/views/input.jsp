...
<form  class="form-inline" method="post" action="singleDate">
<div class="form-group">
...
<H2>N DATE SUBTRACT</H2>
		<form  class="form-inline" method="post" action="subNdDays">
  <label for="date1">First Date:</label><br>
  <input type="text" id="date1" name="date1" value="date" required="required" ><br>
  ...
  <input type="submit"  class="btn btn-success" value="Submit">
	...
	<H2>N DATE ADD</H2>
		<form  class="form-inline" method="post" action="addNdDays">
  <label for="date1">First Date:</label><br>
  <input type="text" id="date1" name="date1" value="date" required="required" ><br>
