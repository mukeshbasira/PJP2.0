...
import com.app.History.History;
import com.app.History.ToCsv;
import com.app.History.showSession;
...
import com.app.dataGenerator.fakeApi;
...
public class InputHandler {
	...
	public localStructure parserAPI(Integer number) throws Exception {
		...
		case optionIntegerFIVE:
			...
			localStructure = new localStructure(optionIntegerFIVE,
					"NONE",
